...
arrowpointers:{
	downarrow: ["/assets/arrow-down.gif", 11,7], //[path_to_down_arrow, arrowwidth, arrowheight]
	rightarrow: ["/assets/arrow-right.gif", 12,12], //[path_to_right_arrow, arrowwidth, arrowheight]
